...
var lab1Canvas = document.getElementById('Canvas4');
				if (lab1Canvas) {
					...
					if (ctx) {
                        ctx.strokeStyle = "black";
                        ctx.fillStyle = "#303067";
                        ctx.lineWidth = 5;
                        ctx.beginPath();
                        ctx.moveTo(40,150);
                        ctx.bezierCurveTo(50,30,230,0,230,170);
                        ctx.stroke();
                        ctx.fill();
                        
                        ctx.beginPath();
                        ctx.moveTo(40,150);
                        ctx.bezierCurveTo(40,250,80,180,90,145);
                        ctx.stroke();
                        ctx.fill();
                        
                        ctx.beginPath();
                        ctx.moveTo(130,150);
                        ctx.bezierCurveTo(100,250,90,150,90,150);
                        ctx.stroke();
                        ctx.fill();
                        
                        ctx.beginPath();
                        ctx.moveTo(160,150);
                        ctx.bezierCurveTo(140,250,130,170,130,150);
                        ctx.stroke();
                        ctx.fill();
                        
                        ctx.beginPath();
                        ctx.moveTo(200,150);
                        ctx.bezierCurveTo(190,250,160,190,160,150);
                        ctx.stroke();
                        ctx.fill();
...
// Draw scene here
            ...
            var lab1Canvas = document.getElementById('Canvas7');
				if (lab1Canvas) {
					...
					if (ctx) {
                        ctx.strokeStyle = "black";
                        ctx.fillStyle = "#ca2424";
                        ctx.lineWidth = 3;
                        
                        ctx.fillRect(25,25,300,250);
                        ctx.strokeRect(25,25,300,250);
                        ...
                        logo.src = "image/logo.png";
                        logo.onload = function() {
                        ctx.drawImage(logo,150, 70, 210, 150);
                    };
